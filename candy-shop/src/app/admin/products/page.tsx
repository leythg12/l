...
const EMPTY_FORM = { name: "", description: "", price: "", image: "", category: "candy", stock: "100", active: true };
    ...
    <div className="max-w-5xl mx-auto">
      ...
      {loading ? (
        ...
        <div className="text-center py-20 text-gray-400">
          ...
          <p>No products yet. Add your first candy!</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {products.map((p) => (
            ...
            >
              <div className="relative h-36 bg-pink-50">
                ...
                {!p.active && (
                  <span className="absolute top-2 left-2 bg-red-100 text-red-600 text-xs px-2 py-0.5 rounded-full font-medium">
                    Hidden
                  </span>
                )}
              </div>
              <div className="p-4">
                ...
                <div className="flex gap-2">
                  <button
                    onClick={() => openEdit(p)}
                    className="flex-1 flex items-center justify-center gap-1 text-xs py-1.5 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors"
                  >
                    <Pencil size={12} /> Edit
                  </button>
                  <button
                  ...
                  <button
                    ...
                    className="flex items-center justify-center w-8 text-red-400 hover:text-red-600 border border-red-100 rounded-lg hover:bg-red-50 transition-colors"
                  >
                    <Trash2 size={12} />
                  </button>
                </div>
            ...
            <form onSubmit={handleSave} className="p-5 space-y-3 max-h-[70vh] overflow-y-auto">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Describe the candy..."
                />
              </div>
